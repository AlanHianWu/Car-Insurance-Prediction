...
output = merge_df["Day_of_Week"].value_counts()

print(output)
print(output.tolist())

bars = pd.DataFrame({'DAYS':["Friday", "Thursday", "Wednesday", "Tuesday", "Monday", "Saturday", "Sunday" ], 'frequency':output.tolist()})

bars.plot.bar(x='DAYS', y='frequency', rot=0) #ylim=(0, 3000000))
