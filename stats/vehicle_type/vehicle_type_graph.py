...
output = merge_df["Vehicle_Type"].value_counts()

print(output)
print(output.tolist())

bars = pd.DataFrame({'Vehicle Type':["Car", "Van Goods <= 3.5t", "Pedal Cycle", "Bus/Coach >= 17 seats",
                                     "Motorcycle > 500cc", "Goods >= 7.5t", "Motorcycle <= 125cc",
                                     "Taxi/Private hire car", "Motorcycle <= 50cc", "Other vehicle",
                                     "Goods > 3.5t & < 7.5t", "Motorcycle > 125cc & <= 500cc",
                                     "Minibus 8-16 seats", "Agricultural vehicle", "Ridden horse",
                                     "None", "Goods vehicle unknown weight", "Mobility scooter",
                                     "Tram", "Motorcycle - unknown cc", "Electric motorcycle"], 'frequency':output.tolist()[1:]})
